...
Esse projeto herda automaticamente o tom de voz, marca e contexto do negócio definidos em `_memoria/` e `criativvo/marca/` da raiz. Não duplicar essas informações aqui.
