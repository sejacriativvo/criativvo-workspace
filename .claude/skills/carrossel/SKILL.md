...
- **Identidade visual:** `criativvo/marca/design-guide.md` — LER ANTES de criar qualquer visual
...
Antes de criar HTML: ler `criativvo/marca/design-guide.md`. Se estiver em branco, usar o "Estilo visual base" acima como default.
...
2. Ler `criativvo/marca/design-guide.md` pra cores, fontes e logo
...
1. Criar **um único `carrossel.html`** com TODOS os slides como `<div class="slide">` dentro do mesmo arquivo. Inline CSS, Google Fonts como única dependência externa. Aplicar:
   - Cores e tipografia de `criativvo/marca/design-guide.md`
...
- Sempre ler `criativvo/marca/design-guide.md` antes de criar qualquer visual
