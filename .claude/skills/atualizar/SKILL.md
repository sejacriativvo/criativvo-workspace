...
description: >
  ...
  `estrategia.md`, `CLAUDE.md`, `criativvo/marca/design-guide.md`) que ficaram desatualizados em relação
...
- **Em `criativvo/marca/design-guide.md`:** continua coerente com o que foi gerado nas últimas peças (carrosséis, slides)?
