...
Ler `_memoria/preferencias.md`. Se estiver vazio:
...
Salvar em `_memoria/preferencias.md`.

### 4. Contexto do negócio

Ler `_memoria/empresa.md`. Se estiver vazio, avisar:
...
Se o usuário responder rápido (sem rodar /setup), anotar o essencial em `_memoria/empresa.md`.
...
2. Ler `_memoria/empresa.md` pra entender contexto e público
