...
> Pra Meta Ads, Google Ads e GA4 a recomendacao e usar skills externas de ads (repos públicos), que ja embrulham as APIs em comandos prontos com as melhores praticas (benchmarks BR, Quality Gates, Health Score). Listadas tambem em `templates/skills/catalogo.md`.
