...
> Nota Criativvo: a pasta `automacoes/` já tem os scripts de Google Drive (`drive.js`, `drive-hook.js`). `scripts/` é pra utilitários novos que as skills MazyOS pedirem (render de carrossel, postagem em rede social, geração de imagem).
