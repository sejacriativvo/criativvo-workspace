...
Tudo que as skills de marketing produzem cai aqui. As skills do MazyOS já sabem onde salvar, você raramente precisa criar pasta manualmente.
...
> Nota Criativvo: trabalho de cliente continua morando em `Cliente-Criativvo/<status>/<cliente>/`. Use `marketing/` pra produção da própria Criativvo ou pra rascunhar antes de mover pra pasta do cliente.
