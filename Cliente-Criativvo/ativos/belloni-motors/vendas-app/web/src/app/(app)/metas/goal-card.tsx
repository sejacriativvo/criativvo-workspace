...
// Cartão de meta mensal. O +/- muda o número NA HORA e só grava no banco
...
export function GoalCard({
  ...
  return (
    <div className="bg-neutral-900 text-white rounded-2xl p-5">
      <div className="text-sm text-neutral-400">Belloni Motors</div>
      ...
      {goal > 0 ? (
        ...
        <p className="mt-2 text-sm text-neutral-400">
          {isAdmin ? 'Defina a meta abaixo.' : 'Meta ainda não definida.'}
        </p>
      )}
