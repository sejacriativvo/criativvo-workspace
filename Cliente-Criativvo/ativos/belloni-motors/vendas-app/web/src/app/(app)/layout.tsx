    ...
    <div className="min-h-dvh bg-neutral-50">
      ...
      <header className="sticky top-0 z-30 border-b border-neutral-200 bg-white lg:hidden">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
          <Link href="/estoque" className="flex items-center" aria-label="Belloni Motors">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/logo-belloni-dark.png" alt="Belloni Motors" className="h-8 w-auto object-contain" />
          </Link>
      ...
      {isAdmin && (
        <AdminReminder semMargem={pendingCount} semCusto={semCusto} />
      )}
