...
export function TopNav({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-3 z-30 hidden justify-center px-4 lg:flex">
      ...
      >
        {/* Marca: GilsonCar */}
        <Link href="/estoque" className="flex shrink-0 items-center pl-1" aria-label="GilsonCar">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/logo-gilsoncar-nav.png" alt="GilsonCar" className="h-9 w-auto object-contain" />
        </Link>
